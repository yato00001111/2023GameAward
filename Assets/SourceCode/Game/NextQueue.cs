...
class NextQueue
{
    ...
    {
        BLOCK_TYPE_MAX = 5,      // 現れる種類(6以下)
        BLOCK_NEXT_HISTORIES = 2,// NEXTの個数
    };
    ...
    Vector2Int CreateNext()
    {
        return new Vector2Int(
            Random.Range(0, (int)Constants.BLOCK_TYPE_MAX) + 1,// [1,BLOCK_TYPE_MAX]の値
    ...
    public void Initialize()
    {
        ...
        for (int t = 0; t < (int)Constants.BLOCK_NEXT_HISTORIES; t++)
        {
